...
static struct tz {
  ...
  { "GMT", "GMT0BST-1,M3.5.0/1,M10.5.0/2"},
  { "CET", "CET-1CEST-2,M3.5.0/2,M10.5.0/3"},
  { "EET", "EET-2EEST-3,M3.5.0/3,M10.5.0/4"},
  { "WET", "WET0WEST-1,M3.5.0/1,M10.5.0/2"},
  { "IST", "IST-1GMT0,M10.5.0/2,M3.5.0/1"},
  { NULL, NULL }
};
